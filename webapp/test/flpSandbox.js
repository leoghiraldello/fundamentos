		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#z10fundamentos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z10fundamentos-display": {
								"semanticObject": "z10fundamentos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z10.fundamentos",
									"url": sap.ui.require.toUrl("z10/fundamentos")
								}
							}
						}
					}
